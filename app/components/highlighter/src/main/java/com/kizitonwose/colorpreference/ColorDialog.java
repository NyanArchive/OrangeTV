...
public class ColorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = layoutInflater.inflate(ResourceManager.get().getLayoutId("orangetv_lib_dialog_colors"), null);

        colorGrid = rootView.findViewById(ResourceManager.get().getId("color_grid"));
    ...
    private void repopulateItems() {
        ...
        for (final int color : colorChoices) {
            View itemView = LayoutInflater.from(context)
                    .inflate(ResourceManager.get().getLayoutId("orangetv_lib_grid_item_color"), colorGrid, false);

            ColorUtils.setColorViewValue(itemView.findViewById(ResourceManager.get().getId("color_view")), color,
    ...
    private void sizeDialog() {
        ...
        int extraPadding = res.getDimensionPixelSize(ResourceManager.get().getDimenId("color_grid_extra_padding"));
