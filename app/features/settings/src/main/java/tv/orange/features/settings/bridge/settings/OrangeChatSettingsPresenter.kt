...
class OrangeChatSettingsPresenter @Inject constructor(
    ...
    override fun getToolbarTitle(): String {
        return ResourceManager.get().getString(resName = "orange_settings_menu_chat")
    }

    override fun updateSettingModels() {
        settingModels.clear()
        settingModels.addAll(OrangeSubMenuWrapper.Chat.convertToMenuModels(controller))
    }
}