...
class OrangePlayerSettingsPresenter @Inject constructor(
    ...
    override fun getToolbarTitle(): String {
        return ResourceManager.get().getString(resName = "orange_settings_menu_player")
    }

    override fun updateSettingModels() {
        settingModels.clear()
        settingModels.addAll(OrangeSubMenuWrapper.Player.convertToMenuModels(controller))
    }
}