...
class OrangeViewSettingsPresenter @Inject constructor(
    ...
    override fun getToolbarTitle(): String {
        return ResourceManager.get().getString(resName = "orange_settings_menu_view")
    }

    override fun updateSettingModels() {
        settingModels.clear()
        settingModels.addAll(OrangeSubMenuWrapper.View.convertToMenuModels(controller))
    }
}