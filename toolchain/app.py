...
if __name__ == '__main__':
    ...
    compile_options_group.add_argument('--skip_app', action='store_true')
    compile_options_group.add_argument('--skip_apk', action='store_true')

    task_group = parser.add_mutually_exclusive_group()
    task_group.add_argument('--decompile', action='store_true', help="Decompile apk and create git repo")
    task_group.add_argument('--jar', action='store_true', help="Convert apk file to twitch jar file using enjarify")
    task_group.add_argument('--check', action='store_true', help="Check patches")
    task_group.add_argument('--generate', action='store_true', help="Generate patches")
    task_group.add_argument('--apply', action='store_true', help="Apply patches")
    task_group.add_argument('--recompile', action='store_true', help="Recompile apk")
    task_group.add_argument('--restore', action='store_true')
    task_group.add_argument('--make', action='store_true')
