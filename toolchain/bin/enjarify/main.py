...
def translate(data, opts, classes=None, errors=None, allowErrors=True, twitch=False):
...
def main():
    ...
    for data in dexs:
        translate(data, opts=opts, classes=classes, errors=errors, twitch=args.twitch)
